...
CREATE TABLE "DOCTOR" (
	...
	"SPECIALTY_CODE"	NUMBER		NOT NULL
);

COMMENT ON COLUMN "DOCTOR"."DOCTOR_NUMBER" IS '의사 번호';

COMMENT ON COLUMN "DOCTOR"."DOCTOR_NAME" IS '의사 이름';

COMMENT ON COLUMN "DOCTOR"."DOCTOR_TEL" IS '의사 연락처';

COMMENT ON COLUMN "DOCTOR"."SPECIALTY_CODE" IS '의사 전공 코드';

CREATE TABLE "ROOM" (
	"ROOM_NO"	NUMBER		NOT NULL,
	"ROOM_NAME"	NUMBER		NOT NULL,
	"ROOM_CODE"	NUMBER		NOT NULL
);

COMMENT ON COLUMN "ROOM"."ROOM_NO" IS '방 번호';

COMMENT ON COLUMN "ROOM"."ROOM_NAME" IS '방 이름';
...
CREATE TABLE "DOCTOR_SPECIALTY" (
	"SPECIALTY_CODE"	NUMBER		NOT NULL,
	"SPECIALTY_NAME"	NVARCHAR2(20)		NOT NULL
);

COMMENT ON COLUMN "DOCTOR_SPECIALTY"."SPECIALTY_CODE" IS '의사 전공 코드';

COMMENT ON COLUMN "DOCTOR_SPECIALTY"."SPECIALTY_NAME" IS '의사 전공 분야';
...
CREATE TABLE "Untitled3" (
	...
	"SCHEDULE_PLACE"	NVARCHAR2(20)		NOT NULL,
	"SCHEDULE_COMPLETION"	NVARCHAR2(1)	DEFAULT 'N'	NOT NULL,
	"SCHEDULE_NAME"	NVARCHAR2(10)		NULL,
	"SCHEDULE_TYPE_CODE"	NUMBER		NOT NULL,
	"MEMBER_NO"	NUMBER		NOT NULL
);

COMMENT ON COLUMN "Untitled3"."SCHEDULE_NO" IS '스케줄 번호';

COMMENT ON COLUMN "Untitled3"."SCHEDULE_TIME" IS '스케줄 시간';

COMMENT ON COLUMN "Untitled3"."SCHEDULE_PLACE" IS '스케줄 장소';

COMMENT ON COLUMN "Untitled3"."SCHEDULE_COMPLETION" IS '스케줄 완료';

COMMENT ON COLUMN "Untitled3"."SCHEDULE_NAME" IS '스케줄 이름';

COMMENT ON COLUMN "Untitled3"."SCHEDULE_TYPE_CODE" IS '스케줄 코드';

COMMENT ON COLUMN "Untitled3"."MEMBER_NO" IS '회원번호';

CREATE TABLE "SCHEDULE_PLACE" (
	"SCHEDULE_NO"	NUMBER		NOT NULL,
	"BUILDING"	NVARCHAR2(30)		NOT NULL,
	"FLOOR"	NVARCHAR2(10)		NULL,
	"PLACE"	NVARCHAR2(20)		NOT NULL
);

COMMENT ON COLUMN "SCHEDULE_PLACE"."SCHEDULE_NO" IS '스케줄 번호';

COMMENT ON COLUMN "SCHEDULE_PLACE"."BUILDING" IS '건물 위치';

COMMENT ON COLUMN "SCHEDULE_PLACE"."FLOOR" IS '건물 층수';

COMMENT ON COLUMN "SCHEDULE_PLACE"."PLACE" IS '장소';

CREATE TABLE "SCHEDULE_TYPE" (
	"SCHEDULE_TYPE_CODE"	NUMBER		NOT NULL,
	"SCHEDULE_TYPE_NAME"	NVARCHAR2(20)		NOT NULL
);

COMMENT ON COLUMN "SCHEDULE_TYPE"."SCHEDULE_TYPE_CODE" IS '스케줄 코드';

COMMENT ON COLUMN "SCHEDULE_TYPE"."SCHEDULE_TYPE_NAME" IS '스케줄 이름(문화생활,병원,게스트룸)';
...
ALTER TABLE "DOCTOR_SPECIALTY" ADD CONSTRAINT "PK_DOCTOR_SPECIALTY" PRIMARY KEY (
	"SPECIALTY_CODE"
);
...
ALTER TABLE "SCHEDULE_TYPE" ADD CONSTRAINT "PK_SCHEDULE_TYPE" PRIMARY KEY (
	"SCHEDULE_TYPE_CODE"
);
...
ALTER TABLE "DOCTOR" ADD CONSTRAINT "FK_DOCTOR_SPECIALTY_TO_DOCTOR_1" FOREIGN KEY (
	"SPECIALTY_CODE"
)
...
ALTER TABLE "Untitled3" ADD CONSTRAINT "FK_SCHEDULE_TYPE_TO_Untitled3_1" FOREIGN KEY (
	"SCHEDULE_TYPE_CODE"
)
...
ALTER TABLE "Untitled3" ADD CONSTRAINT "FK_MEMBER_TO_Untitled3_1" FOREIGN KEY (
	"MEMBER_NO"
)
REFERENCES "MEMBER" (
	"MEMBER_NO"
...
ALTER TABLE "SCHEDULE_PLACE" ADD CONSTRAINT "FK_Untitled3_TO_SCHEDULE_PLACE_1" FOREIGN KEY (
	"SCHEDULE_NO"
)
