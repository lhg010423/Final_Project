...
CREATE TABLE "COMMENT" (
	"COMMENT_NO"	NUMBER		GENERATED BY DEFAULT ON NULL AS IDENTITY PRIMARY KEY,
...
COMMENT ON COLUMN "COMMENT"."REF" IS '댓글 그룹';

COMMENT ON COLUMN "COMMENT"."REF_LEVEL" IS '대댓글의 깊이';
