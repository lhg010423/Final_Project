...
CREATE TABLE `DOCUMENT` (
	`DOCUMENT_NO`	NUMBER	NOT NULL	COMMENT '서류 번호',
	`DOCUMENT_ORIGINAL_NAME`	NVARCHAR2(50)	NOT NULL	COMMENT '서류 이름',
	`DOCUMENT_PATH`	NVARCHAR2(200)	NOT NULL	COMMENT '서류경로',
	`DOC_TYPE_CODE`	NUMBER	NOT NULL	COMMENT '서류타입코드',
	`EXAM_ID`	NUMBER	NOT NULL
);

CREATE TABLE `DOCUMENT_TYPE` (
	`DOC_TYPE_CODE`	NUMBER	NOT NULL	COMMENT '서류 타입 코드(1/2/3/4)',
	`DOC_TYPE_NAME`	NVARCHAR2(20)	NOT NULL	COMMENT '(주민등록본/가족관계/건강검진/신분증)'
);
...
CREATE TABLE `EXAMINATION` (
	...
	`EXAM_STATUS`	CHAR(1)	NOT NULL	DEFAULT 'N',
